...
- **狀態**：Draft（v0.2.3 — 註 v0.2.1 「`/v1/donation/*` 才有版本前綴」描述已過時；BE spec 023 cutover 後 donation 域改走 `/user/v1/donation/*`，auth 仍維持無前綴；本 spec 描述的 `/auth/register` / `/auth/me` 不受影響）
